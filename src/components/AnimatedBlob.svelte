<!-- src/components/AnimatedBlob.svelte -->
<script lang="ts">
    // Any props you want to pass to customize the SVG can be defined here
  </script>
  ...
  <svg class="animated-blob" preserveAspectRatio="xMidYMid slice" viewBox="10 10 80 80">
    <defs>
      <style>
        @keyframes rotate {
          0% {
